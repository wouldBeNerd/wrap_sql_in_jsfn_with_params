...
// let wrap_sql = require("wrqp_sql")
// wrap_sql("exampls_GL_sum",//DO NOT INCLUDE EXTENSION, name of import file will be same as export file, extension will be .js
//     ["company","GL_no", "interco_code"], //variable/parameter names
//     ["Comp Name", "777%", "'_NVT',''"] //values of above parameters to replace 
// )
function wrap_sql(file_name, variable_arr, value_arr){
    let fs = require('fs'), 
        path = require('path')
